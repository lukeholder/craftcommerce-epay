...
class EpayPlugin extends BasePlugin
{
    ...
    public function commerce_registerGatewayAdapters(){
        if($this->commerceInstalled) {
            ...
            require_once __DIR__.'/Epay_GatewayAdapter.php';
            return ['\Commerce\Gateways\Omnipay\Epay_GatewayAdapter'];
        }
        return [];
    }
}